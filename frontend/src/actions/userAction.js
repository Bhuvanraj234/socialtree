...
export const loadUser = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${SOCKET_ENDPOINT}/api/v1/me`);
...
export const logoutUser = () => async (dispatch) => {
    try {
        await axios.get(`${SOCKET_ENDPOINT}/api/v1/logout`);
...
export const getUserDetails = (username) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${SOCKET_ENDPOINT}/api/v1/user/${username}`);
...
export const getUserDetailsById = (userId) => async (dispatch) => {
    try {
        ...
        dispatch({ type: USER_DETAILS_REQUEST });
        const { data } = await axios.get(`${SOCKET_ENDPOINT}/api/v1/userdetails/${userId}`);
...
export const getSuggestedUsers = () => async (dispatch) => {
    try {
        ...
        setTimeout(async () => {
            const { data } = await axios.get(`${SOCKET_ENDPOINT}/api/v1/users/suggested`);
...
export const followUser = (userId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${SOCKET_ENDPOINT}/api/v1/follow/${userId}`);
...
export const forgotPassword = (email) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(
            `${SOCKET_ENDPOINT}/api/v1/password/forgot`,
            { email },
            config
        );
...
export const resetPassword = (token, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(
            `${SOCKET_ENDPOINT}/api/v1/password/reset/${token}`,
            { password },
            config
        );
...
export const updateProfile = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(
            `${SOCKET_ENDPOINT}/api/v1/update/profile`,
            userData,
            config
        );
...
export const updatePassword = (passwords) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(
            `${SOCKET_ENDPOINT}/api/v1/update/password`,
            passwords,
            config
        );
