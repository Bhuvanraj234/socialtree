...
const Profile = () => {
    ...
    return (
        <>
            <MetaData title={`${user?.name} (@${user?.username}) • socialtree photos and videos`} />
                        ...
                        {savedTab ?
                            ...
                            user?.posts?.length > 0 ?
                                ...
                                <div className="bg-white mt-2 mb-10 drop-shadow-sm rounded flex sm:flex-row flex-col sm:gap-0 gap-5 sm:p-0 p-4 items-center justify-between">
                                    <img draggable="false" className="w-2/5 rounded-l" src="https://www.socialtree.com/static/images/mediaUpsell.jpg/6efc710a1d5a.jpg" alt="" />
