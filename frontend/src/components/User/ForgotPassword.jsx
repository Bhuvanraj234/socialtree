        ...
        <>
            ...
            <Auth>
                <div className="bg-white border flex flex-col gap-2 p-4 pt-10">
                    <img draggable="false" className="mx-auto h-30 w-36 object-contain" src="https://www.socialtree.com/static/images/web/mobile_nav_type_logo.png/735145cfe0a4.png" alt="" />
